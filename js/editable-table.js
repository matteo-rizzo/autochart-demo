(function ($, window, document, undefined) {
    var pluginName = "editable", defaults = {
        keyboard: true,
        dblclick: true,
        button: true,
        buttonSelector: ".edit",
    ...
    editable.prototype = {
        ...
        edit: function () {
            ...
            $('td[data-field]', this.element).each(function () {
                var input, field = $(this).data('field'), value = $(this).text(), width = $(this).width();
        ...
        $('table tr').editable({
            dropdowns: {
                ...
                pickers[this] = new Pikaday({
                    field: $("td[data-field=birthday] input", this)[0], format: 'MMM D, YYYY'
                });
